...
// -- return an array of 2 names and use (map)
    ...
    //creates its own array with just the names
  },
...
const clubPrompts = {
  membersBelongingToClubs(clubs) {
    ...
    //Iterate through clubs array and get the member names to use as keys
    //For the value, iterate through clubs looking at the clubs and if the 
    //key is in the club members then return the club name
